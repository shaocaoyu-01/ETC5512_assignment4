...
According to Wenyue Li, Jungang Li(2022), the growth rate of fixed asset of investment has significantly contributed to the growth of the GDP_per_capita.
...
According to Canjiang Song(2018), they found that the elasticity of urbanization rate to per capita GDP growth is about 0.15.

According to Danjiao Zhan(2021), she found the investment on education has contributed to the GDP growth and did a quantitative analysis.
 
According to Dandan Su, she researched the R&D funds have positive relationship with 
GDP Growth rate.

**Datasets：**

1.  **China's GDP level by province (1993-2023)：**
...
2.  **China's province-by-province permanent population data
    (1993-2023)：**
    ...
    -   restrictions: It includes the number of residents in every
        province, but there are still some value not available.
    -   ethics and privacies:

3.  **China's industrial structure by province:**

4.  **Fixed asset investment growth rate by province:**

5.  **Urbanization rate by province:**

6.  **Human capital level by province:**

7.  **Degree of openness by province:**

8.  **Technology investment by province:**
...
10.**Division of economic zones in each province:** - source: Chinese
