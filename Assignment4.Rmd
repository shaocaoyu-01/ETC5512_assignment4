...
2. **China's province-by-province permanent population data (1993-2023)：**

    -  source: Chinese National Bureau of Statistics(https://data.stats.gov.cn/adv.htm?cn=C01)
    -  content: It includes the population data in every province in China mainland from 1993 to 2023
    -  recent updated:
    -  data form:CSV
    -  restrictions: It includes the number of residents in every province, but there are still some value not available.
    -  ethics and privacies:
...
10.**Division of economic zones in each province:**
