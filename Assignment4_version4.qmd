...
# Reasearch between the GDP per capita and its growth rate by province in China {.tabset}
...
finally used the manual input method. The data we use is about China, most of the data is downloaded from
...
*Also submit 4 earlier versions of your assignment to show your iterative process. 
These should be your messy versions and include exploratory code. We recommend you
save these files as you progress through your assignment. Provide a short overview 
for markers of what you fixed/learnt/improved/changed between each file. 
(If you are comfortable with GitHub you may submit your Github repo, but please 
